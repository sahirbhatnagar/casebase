...
# devtools::load_all()
plot(pt_object)
plot(pt_object, add.case.series = FALSE)
plot(pt_object, add.case.series = TRUE)
plot(pt_object, add.case.series = TRUE, add.base.series = TRUE)
```
...
plot(popTimeData,
     ...
     fill.params = list(name = "Legend Name",
                        ...
                        values = c("Relapse" = "blue", "Competing event" = "pink", "Base series" = "orange")),
